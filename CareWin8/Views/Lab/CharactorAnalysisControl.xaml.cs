...
namespace CareWin8
{
    public sealed partial class CharactorAnalysisControl : UserControl
    {
        #region Param1Property
        public static readonly DependencyProperty Param1Property =
            DependencyProperty.Register("Param1", typeof(int), typeof(CharactorAnalysisControl), new PropertyMetadata((int)0));
        ...
        public static readonly DependencyProperty Param2Property =
            DependencyProperty.Register("Param2", typeof(int), typeof(CharactorAnalysisControl), new PropertyMetadata((int)0));
        ...
        public static readonly DependencyProperty Param3Property =
            DependencyProperty.Register("Param3", typeof(int), typeof(CharactorAnalysisControl), new PropertyMetadata((int)0));
        ...
        public static readonly DependencyProperty Param4Property =
            DependencyProperty.Register("Param4", typeof(int), typeof(CharactorAnalysisControl), new PropertyMetadata((int)0));
        ...
        public static readonly DependencyProperty Param5Property =
            DependencyProperty.Register("Param5", typeof(int), typeof(CharactorAnalysisControl), new PropertyMetadata((int)0));
        ...
        public CharactorAnalysisControl(int param1, int param2, int param3, int param4, int param5)
        {
            Param1 = param1;
            Param2 = param2;
            Param3 = param3;
